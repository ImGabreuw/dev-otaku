...
@Data
public class ComicInfoSummary implements SelfValidation<ComicInfoSummary> {
    ...
    public ComicInfoSummary(Title title, Score score, Image image, Progress progress) {
        this.title = title;
        this.score = score;
        this.image = image;
